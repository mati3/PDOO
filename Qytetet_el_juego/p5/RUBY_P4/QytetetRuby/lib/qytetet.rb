...
module ModeloQytetet
  ...
  class Qytetet
          ...
          if @cartaActual.tipo == TipoSorpresa::PORCASAHOTEL
            ...
            if @cartaActual.tipo == TipoSorpresa::PORJUGADOR
              @jugadores.each do |j|  
                ...
                @jugadores[entero] = @jugadorActual
            end
          end
        end
      end
    ...
    private ###################################### Cuidado con este private y comprobar que los metodos debajo son verdaderamente privados, to_s estaba en privado sin deberlo estar
    ...
    def inicializarCartasSorpresa#private void inicializarCartasSorpresa() 
      ...
      @mazo << Sorpresa.new("Convertirme ... ¡Que suerte,te conviertes 3000€!",3000,TipoSorpresa::CONVERTIRME)
      @mazo << Sorpresa.new("Convertirme ... ¡Que suerte,te conviertes 5000€!",5000,TipoSorpresa::CONVERTIRME)
      ...
      #@mazo = @mazo.shuffle # Dejo que las primeras cartas sean las de convertirme para probarlo, descomentar el shuffle para barajar las sorpresas
    end
