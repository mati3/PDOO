...
module ModeloQytetet
  class Tablero
    ...
    def inicializar 
      ...
      calle = OtraCasilla.new(0,TipoCasilla::SALIDA)
      @casillas << calle
      
      tomate = TituloPropiedad.new("Tomate",false,50,10,150,250)
      calle = Casilla.new(1,250,tomate)
      @casillas << calle
      ...
      calle = OtraCasilla.new(3,TipoCasilla::SORPRESA)
      @casillas << calle
      
      @carcel = OtraCasilla.new(4,TipoCasilla::CARCEL) ############### CARCEL #################
      @casillas << @carcel
      ...
      calle = OtraCasilla.new(8,TipoCasilla::IMPUESTO)
      @casillas << calle
      ...
      calle = OtraCasilla.new(10,TipoCasilla::SORPRESA)
      @casillas << calle
      ...
      calle = OtraCasilla.new(12,TipoCasilla::JUEZ)
      @casillas << calle
      ...
      calle = OtraCasilla.new(15,TipoCasilla::SORPRESA)
      @casillas << calle
      ...
      calle = OtraCasilla.new(18,TipoCasilla::PARKING)
      @casillas << calle
