...
module ModeloQytetet
  class Jugador
    ...
    def initialize(nombre)
      ...
      @casillaActual  = Casilla.new(0,TipoCasilla::SALIDA) # Casilla
      @propiedades = Array.new() # TituloPropiedad
    end
    
    def jugadorCopia(jugador)
    ...
    def convertirme(fianza)
      aux = Especulador.new(self, fianza)
      return aux
    end  
    ...
    def modificarSaldo(cantidad) #void modificarSaldo(int cantidad )
      #EXAMEN INI  entiendo que no puede bajar mas de 2000 de golpe
      if(cantidad > -2000)
        cantidad = -2000
      end
      #EXAMEN FIN
   ...
   # protected :jugadorCopia , :pagarImpuestos #, :convertirme #, actualizarPosicion
    public :to_s
